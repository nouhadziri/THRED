...
from models.thred import thred_iterators
from models.thred.thred_model import TopicAwareHierarchicalSeq2SeqModel
...
def create_train_model(hparams, scope=None, num_workers=1, jobid=0):
    ...
    with graph.as_default(), tf.container(scope or "train"):
        ...
        iterator = thred_iterators.get_iterator(
            dataset,
            vocab_table,
            hparams.batch_size,
            hparams.num_turns,
...
def create_infer_model(hparams, scope=None):
    ...
    with graph.as_default(), tf.container(scope or "infer"):
        ...
        iterator = thred_iterators.get_infer_iterator(
            src_dataset,
            vocab_table,
